package es.gva.edu.db

import es.gva.edu.schemas.TasksSchema
...
object ConexionDB {
    ...
    private const val DATABASE = "app" // Nombre de nuestra BD
    ...
    fun conectar() {
        try {
            ...
            transaction(db) {
                ...
                SchemaUtils.create(TasksSchema)
                println("Esquema de la tabla 'Tasks' verificado/creado.")
            }
